...
/*
* Returns true if the id of service_net is higher than the one of server
*/
...
/*
* Gets the start server from the central server
*/
...
/*
* Gets the despatch server from the central server
*/
...
/*
* Sets itself as the start service
*/
...
/*
* Sets itself as the despatch service
*/
...
/*
* Prepares itself to receive connection requests from other servers
*/
...
/*
* Connects itself to the start service in the ring
*/
...
/*
* As the start service, accepts a new server
*/
...
/*
* Closes the sockets from the previous and next server
*/
...
/*
* Informs the central that this is no longer the despatch
*/
...
/*
* Informs the central that this is no longer the start server
*/
...
/*
* Reads and analyzes the message received from the previous server
*/
...
/*
* Decides the action to take for a Token S
*/
...
/*
* Decides the action to take for a Token T
*/
...
/*
* Decides the action to take for a Token I
*/
...
/*
* Decides the action to take for a Token D
*/
...
/*
* Decides the action to take for a Token NEW
*/
...
/*
* Decides the action to take for a Token N
*/
...
/*
* Decides the action to take for a Token O
*/
...
/*
* Decides the action to take for a Token NEW_START
*/
state HandleTokenNS() {
  if (verbose_option)
...
/*
* Sends a token S to the next server
*/
...
/*
* Sends a token T to the next server
*/
...
/*
* Sends a token I to the next server
*/
...
/*
* Sends a token D to the next server
*/
...
/*
* Sends a token NEW to the next server
*/
...
/*
* Sends a token N to the next server
*/
...
/*
* Sends a token O to the next server
*/
...
/*
* Sends a token NEW_START to the next server
*/
...
/*
* Sends the same token it received to the next server
*/
...
/*
* Converts the received token O into a server struct
*/
...
/*
* Converts the received token N into a server struct
*/
...
/*
* Converts the received token NEW into a server struct
*/
...
/*
* Makes the UDP socket for clients available
*/
...
/*
* Receives the data from the client and analyzes it, returning the action
*/
  ...
  while (service_state != exiting) {
    ...
    if (FD_ISSET(fileno(stdin), &rfds)) {
      ...
      if (strcmp(splitted_buffer, "join")==0
        ...
        // Decide if it joins an existing ring or creates one
        switch (GetStart(&service_net, &central_server)) {
          ...
          case join :
            ...
            if (ConnectRing(&service_net, &next_server,
              ...
              CloseServers(&prev_server, &next_server);
              goto join_error;
            }
            break;
          default :
    ...
    // Socket action - previous server sending stuff
    if (prev_server.fd != -1
    ...
    // Socket action - client contacting
    if (client.fd != -1
